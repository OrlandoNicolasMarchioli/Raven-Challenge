...
struct ProductCell: View {
    @State var product: SelectedArticleData
...
// Vista para mostrar una celda de articulos con genéricos
struct ArticleCellChip<T>: View {
    let item: T
